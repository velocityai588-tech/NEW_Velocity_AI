...
export const LiveMeetingAssistant: React.FC = () => {
  ...
  if (!isOpen) return (
    <button
      ...
      className="fixed bottom-24 right-6 w-12 h-12 rounded-full bg-[#2DD4BF] text-white flex items-center justify-center shadow-[0_4px_20px_rgba(45,212,191,0.4)] hover:shadow-[0_4px_24px_rgba(45,212,191,0.6)] hover:scale-105 transition-all duration-200 z-50"
